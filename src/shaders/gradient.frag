...
void main() {
    ...
    float wave1 = sin(screenspace.x * 10.0 + u_scroll / 600.0 + u_time / 3000.0) / 8.0 + 0.75;
    float wave2 = sin(screenspace.x * 6.5 + u_scroll / 400.0 + u_time / 2000.0) / 8.0 + 0.5;
    float wave3 = sin(screenspace.x * 3.0 + u_scroll / 200.0 + u_time / 1000.0) / 8.0 + 0.25;
