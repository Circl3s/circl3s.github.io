import './MiniNews.svelte.css.proxy.js';
/* src/index/MiniNews.svelte generated by Svelte v3.38.3 */
import {
	SvelteComponent,
	append,
	attr,
...
function create_content_slot(ctx) {
	...
	return {
		c() {
			...
			attr(img, "class", "thumb svelte-1aaiq3e");
			...
			attr(p, "class", "svelte-1aaiq3e");
			attr(div, "class", "content svelte-1aaiq3e");
...
// (172:12) {#each post_array as post}
function create_each_block(ctx) {
	...
	return {
		c() {
			...
			t = space();
			attr(div, "class", "mobile-first svelte-1aaiq3e");
		},
		m(target, anchor) {
			insert(target, div, anchor);
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			div1 = element("div");
			h1 = element("h1");
			h1.innerHTML = `<a href="/news">News</a>`;
			t3 = space();
			div0 = element("div");
			if_block.c();
			t4 = space();
			a1 = element("a");
			a1.textContent = "See more →";
			attr(h1, "class", "svelte-1aaiq3e");
			attr(a1, "href", "/news");
			attr(a1, "class", "more svelte-1aaiq3e");
			attr(div0, "class", "items svelte-1aaiq3e");
			attr(div0, "id", "items");
			attr(div1, "class", "MiniNews svelte-1aaiq3e");
		},
		m(target, anchor) {
...
class MiniNews extends SvelteComponent {
	constructor(options) {
		super();
