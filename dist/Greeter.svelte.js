...
/* src/Greeter.svelte generated by Svelte v3.38.3 */
import {
	SvelteComponent,
	add_render_callback,
	append,
...
import { draw, fade } from "../_snowpack/pkg/svelte/transition.js";
...
function create_if_block(ctx) {
	...
	return {
		c() {
			...
			attr(svg2, "class", "svelte-vcpa8w");
			attr(div, "class", "row svelte-vcpa8w");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "Greeter svelte-vcpa8w");
		},
		m(target, anchor) {
			insert(target, div, anchor);
